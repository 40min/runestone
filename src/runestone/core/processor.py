...
class RunestoneProcessor:
    ...
    def __init__(
        ...
        try:
            self.ocr_processor = OCRProcessor(client=self.client, verbose=verbose)
    ...
    def process_image(self, image_path: Path) -> Dict[str, Any]:
        ...
        try:
            ...
            if self.verbose:
                ...
                self.console.print(f"[green]✓[/green] Extracted {char_count} characters")
            ...
            if self.verbose:
                ...
                self.console.print(f"[green]✓[/green] Found {vocab_count} vocabulary items")
            ...
            if self.verbose:
                ...
                self.console.print(f"[green]✓[/green] Found {resource_count} learning resources")
    ...
    def display_results_console(self, results: Dict[str, Any]) -> None:
        """
        Display processing results to console using Rich formatting.
    ...
    def display_results_markdown(self, results: Dict[str, Any]) -> None:
        """
        Display processing results as markdown output.
