...
class OpenAIClient(BaseLLMClient):
    ...
    def search_resources(self, prompt: str) -> str:
        ...
        try:
            ...
            Since I don't have real-time web search capabilities, please provide detailed suggestions for high-quality Swedish language learning resources that would be relevant to the search query. Format your response as if you found actual resources, including realistic URLs from these trusted sources:
