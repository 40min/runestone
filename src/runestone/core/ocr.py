...
class OCRProcessor:
    ...
    def extract_text(self, image_path: Path) -> Dict[str, Any]:
        ...
        try:
            ...
            ocr_prompt = """
            Please extract ALL text from this Swedish textbook page image. Follow these
            instructions:

            1. Transcribe all Swedish text exactly as it appears, maintaining original
            formatting
            ...
            Return the extracted text in a clear, organized format. If you cannot read any
            meaningful Swedish text, respond with "ERROR: Could not recognise text on the
            page."
            """
