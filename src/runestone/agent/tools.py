...
def create_update_memory_tool(user_service, user):
    """
    Factory to create an update_memory tool with access to user context.
    ...
    Returns:
        A LangChain tool function bound to the given user context
    """
