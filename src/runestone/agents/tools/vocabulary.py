...
class WordPrioritisationItem(BaseModel):
    ...
    @field_validator("word_phrase", "translation", "example_phrase", "extra_info", mode="before")
    @classmethod
    def decode_unicode_escapes(cls, v: str | None) -> str | None:
        ...
        for word_item in words:
            try:
                result = await vocab_service.upsert_priority_word(
                    ...
                    extra_info=word_item.extra_info,
                    user_id=user.id,
                )
