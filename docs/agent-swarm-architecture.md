...
timeout after settings loading. Gemini agent timeouts below 10.0 seconds are
raised to the provider minimum after agent defaults are resolved, and the
configuration loader logs each adjustment.
