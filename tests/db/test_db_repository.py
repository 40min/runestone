...
class TestVocabularyRepository:
    ...
    def test_select_new_daily_words_prioritization(self, repo, db_session):
        ...
        result = repo.select_new_daily_words(user_id=1, limit=4)
...
class TestVocabularyRepositoryStats:
    ...
    def test_get_words_skipped_count(self, db_session: Session):
        ...
        count = repo.get_words_skipped_count(user.id)
        assert count == 2

    def test_get_overall_words_count(self, db_session: Session):
        ...
        count = repo.get_overall_words_count(user.id)
        assert count == 3
